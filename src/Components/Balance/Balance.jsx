...
const Balance = () => {
  ...
  return (
    <section className='g-wrapper'>
      <div className={'g-container ' + style.balanceContainer}>
        <div>
        ...
        <div className={style.visibilityIconContainer}>
          <div
            className={style.iconPadding}
            onClick={() => setIsValueVisible(!isValueVisible)}
          >
            {isValueVisible ? <VisibilityOn /> : <VisibilityOff />}
          </div>
        </div>
      </div>

      <div className={'g-container ' + style.indicators}>
        <div className={style.incomeContainer}>
          <div className={style.iconBackground}>
            <img src={trendingUpIcon} alt='Ícone receitas' />
          </div>
          <div className={style.indicatorInfo}>
        ...
        <div className={style.outgoingContainer}>
          <div className={style.iconBackground}>
            <img src={trendingDownIcon} alt='Ícone despesas' />
          </div>
          <div className={style.indicatorInfo}>
